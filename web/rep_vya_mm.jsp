        ...
        <div class="min-h-full">
            ...
            <main>
                <%
                    ...
                    String url = "jdbc:mysql://localhost:3308/elet";
                    String usuario = "root";
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            ...
                                                            <button type="button" name="area" value="Mantenimiento" >
                                                                <a href="rep_eng.jsp?id_case=<%= ids%>" class="rounded-md bg-stone-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-stone-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-600">Ingeniero de Mantenimiento</a>
                                                            </button>
